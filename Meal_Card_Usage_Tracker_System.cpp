 ...
 *
 * Group Members :
 *  1. Nahom Dejene      - UGR/8092/17
 *  2. Solomon Getahun   - UGR/5063/17
 *  3. Binyam Abate      - UGR/2730/17
 *  4. Mideksa Abera     - UGR/9960/17
 *
 * Academic Purpose :
 * This project was developed as an academic group project to demonstrate
 * practical application of C++ concepts including file handling, data structures,
